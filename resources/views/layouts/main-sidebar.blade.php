...
<aside class="app-sidebar sidebar-scroll">
    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            <li class="side-item side-item-category">@lang('sidebar.Billing software')</li>
            <li class="slide">
                <a class="side-menu__item" href="{{ url('/' . $page='home') }}">
                    ...
                    <span class="side-menu__label">@lang('sidebar.Main')</span></a>
            </li>
            <li class="side-item side-item-category">@lang('sidebar.Invoices')</li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    ...
                    <li><a class="slide-item" href="#">@lang('sidebar.Partially Paid Invoices')</a>
                    </li>

                </ul>
            </li>

            <li class="side-item side-item-category">@lang('sidebar.Reports')</li>
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                    <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                        <path d="M0 0h24v24H0V0z" fill="none"/>
                    ...
                    <span class="side-menu__label">@lang('sidebar.Reports')</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="#">@lang('sidebar.Billing Reports')</a></li>
                    <li><a class="slide-item" href="#">@lang('sidebar.Customer Reports')</a></li>
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                    ...
                    <span class="side-menu__label">@lang('sidebar.Users')</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="#">@lang('sidebar.Users')</a></li>
                    <li><a class="slide-item" href="#">@lang('sidebar.Permissions')</a></li>

                </ul>
            </li>

            <li class="side-item side-item-category">@lang('sidebar.Settings')</li>
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
